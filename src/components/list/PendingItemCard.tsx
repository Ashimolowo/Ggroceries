import { GgoceriesItem, useGgoceriesStore } from "@/store/ggoceries-store";
...
const PendingItemCard = ({ item }: { item: GgoceriesItem }) => {
  const { removeItem, updateQuantity, togglePurchased } = useGgoceriesStore();
